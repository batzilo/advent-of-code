...
// Returns true on success, false otherwise.
bool test_dpc_add_integers_then_erase_them(size_t n) {
  struct dynamic_packed_container *dpcp = NULL;
  assert(dpcp == NULL);
...
bool test_dpc_add_sixty_three_integers_then_erase_them() {
  return test_dpc_add_integers_then_erase_them(63);
}

bool test_dpc_add_sixty_four_integers_then_erase_them() {
  return test_dpc_add_integers_then_erase_them(64);
}
...
bool run_all_tests() {
  ...
  TEST(test_dpc_add_sixty_three_integers_then_erase_them);
  TEST(test_dpc_add_sixty_four_integers_then_erase_them);
  TEST(test_dpc_sort);
